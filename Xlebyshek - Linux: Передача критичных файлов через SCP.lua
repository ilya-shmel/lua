...
-- Переменные для отслеживания паттернов
local pattern_cache = {}
...
-- Функция извлечения путей из логлайна (initiator.command.executed)
...
-- Функция конвертации шаблона регулярного выражения
...
-- Функция тестирования регулярного выражения
...
-- Универсальная функция анализа: возвращает true/false если проходит регулярка
...
-- Функция проверки: является ли файл/путь, извлеченный из логлайна, критичным 
