...
-- Snort initialize and configure section
--snort = snort or {}

--snort.interface = 'ens192'
--snort.daq = 'afpacket'
--snort.mode = 'tap'
...
binder =
{
    ...
    { when = { proto = 'tcp', ports = '80 8080', role='server' }, use = { type = 'http_inspect' } },
...
daq_dir = { "/usr/local/lib/daq_s3/lib/daq" }