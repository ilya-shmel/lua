...
function on_matched(grouped, matchedData)
    ...
    alert({template = [[Останов и последующая деактивация службы Windows.
